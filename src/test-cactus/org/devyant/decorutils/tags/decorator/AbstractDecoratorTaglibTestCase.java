...
public abstract class AbstractDecoratorTaglibTestCase extends JspTestCase {
     ...
     */
    public static final String DECORATOR_CLASS
        = "org.devyant.decorutils.decorators.DateDecorator";
    /**
     * The DECORATOR_CLASS <code>String</code>.
     */
    public static final String WRAPPER_CLASS
        = "org.devyant.decorutils.tags.decorator.TestWrapper";
    /**
    ...
    protected final void setUp() {
        ...
        // attributes (decorator, name, property)
    ...
    protected static final void verifyOutput(final String output) {
        ...
        assertEquals("DecorateTag did not output correctly.",
                expected, output);
    }
